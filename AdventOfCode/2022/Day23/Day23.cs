...
namespace AdventOfCode._2022.Day23
{
    ...
    {
        public Day23() : base(2022, 23, "Day23/input_2022_23.txt", "3987", "")
        {

        }

        InfiniteGrid2D<char> _initialState = new InfiniteGrid2D<char>('.');
        public override void Initialise()
        {
            ...
            foreach (var line in InputLines)
            {
                ...
                foreach (var c in line)
                {
                    ...
                    if (c == '#')
                    {
                        _initialState.Write(x, y, alphabet[elvesAdded]);
                        elvesAdded += 1;
        ...
        private void Print(InfiniteGrid2D<char> space)
        {
            var allElves = space.FindCoordinates(x => x != '.');
            ...
            Console.WriteLine($"Origin {minX},{minY}");
